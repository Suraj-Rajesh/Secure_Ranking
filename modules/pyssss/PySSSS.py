...
if __name__ == "__main__":
  import StringIO
  input_data = StringIO.StringIO("241722186245817696767932101330114348144 73925553509002540078680971706686886478 241722186245817696799308876431220754219")
  outputs = []
  n = 5
  k = 3
  for i in xrange(n):
